  ...
  async findAll(
    ...
    const queryBuilder = this.treinoRepository
      ...
      .select([
        ...
        'treino.descricao',
        'treino.exercicios',
        'treino.series_repeticoes',
        'treino.exercicios_detalhados',
        'treino.observacoes',
        'treino.imagem_url',
        'treino.imagem_capa_url',
        'treino.video_url',
        'treino.video_explicativo_url',
        'treino.nivel',
        'treino.dia_semana',
        'treino.duracao_minutos',
        'treino.dias_por_semana',
        'treino.grupos_musculares',
        'treino.is_premium',
        'treino.is_inedito',
        'treino.equipamentos',
        'treino.tags',
        'treino.tipo_treino',
        'treino.tipo_dica',
        'treino.tipo_equipamento_casa',
        'treino.substituicoes_exercicios',
        'treino.substituto_id_1',
        'treino.substituto_id_2',
        'treino.descricao_tecnica',
        'treino.substituto_1_info',
        'treino.substituto_2_info',
        'treino.mostrar_ponto_partida',
        'treino.avaliacao',
        'treino.total_avaliacoes',
        'treino.ativa',
        'treino.ordem',
        'treino.created_at',
        'treino.updated_at',
