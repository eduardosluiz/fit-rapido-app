                  ...
                  <tr key={receita.id} className="hover:bg-gray-50/50 dark:hover:bg-[#1a1a1a]/50 transition-colors">
                    <td className="px-6 py-4 flex items-center gap-4">
                      {receita.imagem_url ? (
                        ...
                        <div className="w-12 h-12 bg-white dark:bg-[#222] rounded flex items-center justify-center border border-gray-200 dark:border-gray-800">
                          <span className="text-xs text-gray-400">Sem Img</span>
                        </div>
                      )}
                      <div>
                        <div className="font-normal text-gray-900 dark:text-white">{receita.titulo}</div>
                    ...
                    <td className="px-6 py-4 text-center">
                      {receita.destaque_popular ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded bg-white dark:bg-[#222] text-gray-500 text-[10px] font-normal uppercase tracking-widest border border-gray-200 dark:border-gray-800">
                          <XCircle size={12} /> Não
                        </span>
                      )}
                    </td>
