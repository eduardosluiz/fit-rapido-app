  ...
  return (
    <div className="p-6 sm:p-10 bg-[#fafafa] dark:bg-[#0a0a0a] min-h-screen">
      <div className="w-full max-w-[1400px] mx-auto space-y-6 md:space-y-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-gray-100 dark:border-[#222] pb-4 gap-4">
          <div>
            <h1 className="text-xl font-light text-gray-400 dark:text-gray-500 tracking-tight uppercase">
              Gerenciar <span className="text-gray-800 dark:text-white font-normal">Receitas</span>
            </h1>
            <div className="flex items-center gap-3 mt-1">
              <p className="text-[10px] text-gray-400 font-normal uppercase tracking-[0.2em]">Catálogo Gastronômico Fitness</p>
              ...
              <div className="md:hidden flex items-center gap-1.5 bg-blue-50 dark:bg-blue-900/20 px-2 py-0.5 rounded-md border border-blue-200 dark:border-blue-800">
                ...
                <span className="text-[10px] font-normal tracking-wide text-blue-700 dark:text-blue-400">
          ...
          <div className="flex justify-center md:justify-end items-center gap-3 w-full md:w-auto mt-2 md:mt-0">
            <button 
              ...
              className="flex-1 md:flex-none max-w-[220px] md:w-auto justify-center px-4 py-2.5 rounded-lg border border-[#c8921a]/40 text-[#c8921a] text-[11px] font-normal uppercase tracking-widest hover:bg-[#c8921a]/10 hover:border-[#c8921a] transition-all duration-300 flex items-center gap-2"
            >
              <FolderPlus size={16} /> Categorias
            </button>
            <Link 
              href="/admin/receitas/nova"
              className="flex-1 md:flex-none max-w-[220px] md:w-auto justify-center px-4 py-2.5 rounded-lg border-2 border-[#c8921a] bg-[#c8921a] text-white text-[11px] font-normal uppercase tracking-widest hover:bg-[#b58315] hover:border-[#b58315] transition-all duration-300 flex items-center gap-2"
            >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4">
             ...
             <div className="hidden md:flex items-center gap-2 bg-blue-50 dark:bg-blue-900/20 px-4 py-2 rounded-lg border border-blue-200 dark:border-blue-800 shadow-sm whitespace-nowrap">
                ...
                <span className="text-[11px] font-normal tracking-wide text-blue-700 dark:text-blue-400">
                  FREE: {freeCount !== null ? freeCount : '...'}
                </span>
             </div>
        ...
        {error && (
          <div className="p-4 bg-red-50 text-red-600 text-xs font-normal rounded-lg border border-red-100">
            {error}
          </div>
        )}
