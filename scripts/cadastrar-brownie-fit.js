/**
 * Script para cadastrar a receita "Brownie Fit de Chocolate"
 * 
 * USO:
 * Execute: node scripts/cadastrar-brownie-fit.js
 * 
 * O script:
...
// Receita "Brownie Fit de Chocolate"
const receita = {
  titulo: '🍫 Brownie Fit de Chocolate',
  descricao: 'Brownie intenso, macio por dentro, sem açúcar e perfeito para matar a vontade de doce sem sair do foco.',
  ingredientes: [
    '2 ovos',
    '80 g de xilitol',
    '170 g de chocolate meio amargo zero açúcar',
  ...
  modo_preparo: [
    'Em uma tigela, bata bem os ovos com o xilitol até obter uma mistura clara.',
    'Derreta o chocolate com o óleo de coco no micro-ondas, em intervalos curtos, mexendo entre eles.',
    'Misture o chocolate derretido aos ovos batidos.',
    'Acrescente o cacau, a farinha de amêndoa e o bicarbonato, mexendo até ficar homogêneo.',
    'Transfira para uma forma pequena untada ou forrada com papel manteiga.',
    'Leve ao forno preaquecido a 180 °C por 20 a 25 minutos.',
    'Deixe esfriar levemente antes de cortar.'
  ],
  tempo_preparo: 32, // Preparo: 10 minutos + Cozimento: 20-25 minutos (média 22.5) = ~33 minutos
  porcoes: 10, // 10 brownies
  dificuldade: 'medio',
  tipo_refeicao: 'snacks', // Lanche saudável / Sobremesa fit
  tags: ['Lanche saudável', 'Sobremesa fit', 'Low carb', 'Sem açúcar'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por porção - 1 brownie)
  calorias: 180, // Média entre 170-190 kcal
  carboidratos: 7, // Média entre 6-8 g
  proteinas: 3.5, // Média entre 3-4 g
  gorduras: 15, // Média entre 14-16 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por unidade (1 brownie)
* Calorias: ~170–190 kcal
* Carboidratos: ~6–8 g
* Proteínas: ~3–4 g
* Gorduras: ~14–16 g
...
– tamanho das porções`,
  ...
  substituicoes_ingredientes: {
    'Xilitol': ['eritritol', 'blend culinário sem açúcar (mesma proporção)'],
    'Chocolate meio amargo zero açúcar': ['chocolate 70% cacau (ajustar adoçante se necessário)'],
    'Óleo de coco': ['manteiga ghee', 'manteiga sem sal'],
    'Farinha de amêndoa': ['farinha de castanha de caju', 'farinha de coco (usar apenas 1½ colher de sopa)'],
    'Cacau em pó': ['chocolate em pó 70% cacau'],
    'Bicarbonato': ['fermento químico (dobrar a quantidade)']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍫 Cadastro de Brownie Fit de Chocolate${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
