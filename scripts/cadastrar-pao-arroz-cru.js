/**
 * Script para cadastrar a receita "Pão de Arroz Cru"
 * 
 * USO:
 * Execute: node scripts/cadastrar-pao-arroz-cru.js
 * 
 * O script:
...
// Receita "Pão de Arroz Cru"
const receita = {
  titulo: '🍞 Pão de Arroz Cru',
  descricao: 'Pão leve, macio e naturalmente sem glúten, feito apenas com arroz cru batido no liquidificador.',
  ingredientes: [
    '350 g de arroz branco cru',
    '230 ml de água (temperatura ambiente)',
  ...
  modo_preparo: [
    'Deixe o arroz branco cru de molho por 2 horas.',
    'Escorra toda a água e reserve.',
    'No liquidificador, bata a água, o óleo de coco, o mel, o arroz escorrido e o sal até obter uma massa lisa e homogênea.',
    'Acrescente o fermento biológico seco e bata rapidamente apenas para misturar.',
    'Transfira a massa para uma forma untada.',
    'Cubra e deixe descansar até dobrar de volume.',
    'Pré-aqueça o forno a 180 °C por 15 minutos.',
    'Asse por 45 a 50 minutos, até dourar.',
    'Retire do forno e deixe esfriar completamente antes de cortar.'
  ],
  tempo_preparo: 200, // Preparo + descanso: ~2h30 (150 min) + Cozimento: 45-50 min (média 47.5) = ~197.5 minutos (arredondado para 200)
  porcoes: 12, // 1 pão médio (aprox. 10–12 fatias) - usando 12 como padrão
  dificuldade: 'medio',
  tipo_refeicao: 'sides', // Pão saudável
  tags: ['Pão saudável', 'Sem glúten', 'Caseiro', 'Sem farinha'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por fatia - 1/12 do pão)
  calorias: 127, // Média entre 120-135 kcal
  carboidratos: 23, // Média entre 22-25 g
  proteinas: 2.5, // Média entre 2-3 g
  gorduras: 3.5, // Média entre 3-4 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por fatia (1/12 do pão)
* Calorias: ~120–135 kcal
* Carboidratos: ~22–25 g
* Proteínas: ~2–3 g
* Gorduras: ~3–4 g

➡️ Valores podem variar conforme:
– tipo de arroz utilizado
– tamanho das fatias
– substituições feitas`,
  aviso_nutricional: 'Valores nutricionais estimados via aplicativo e não substituem orientação nutricional profissional. Observação importante: Não utilize arroz parboilizado, pois ele compromete a textura e o crescimento da massa.',
  substituicoes_ingredientes: {
    'Óleo de coco': ['azeite de oliva suave', 'óleo de abacate'],
    'Mel': ['açúcar de coco', 'melado', '1½ colher de sopa de açúcar mascavo'],
    'Sal rosa': ['sal marinho comum'],
    'Fermento biológico seco': ['fermento biológico fresco (30 g)']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍞 Cadastro de Pão de Arroz Cru${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
