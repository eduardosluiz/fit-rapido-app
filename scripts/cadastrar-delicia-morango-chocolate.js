/**
 * Script para cadastrar a receita "Delícia de Morango com Chocolate"
 * 
 * USO:
 * Execute: node scripts/cadastrar-delicia-morango-chocolate.js
 * 
 * O script:
...
// Receita "Delícia de Morango com Chocolate"
const receita = {
  titulo: '🍓🍫 Delícia de Morango com Chocolate',
  descricao: 'Morangos cremosos por dentro e crocantes por fora, com contraste perfeito entre fruta, iogurte e chocolate.',
  ingredientes: [
    '10 morangos médios',
    '½ pote de iogurte grego natural sem açúcar',
    '80 g de chocolate 70% cacau ou chocolate sem açúcar'
  ],
  modo_preparo: [
    'Lave e seque bem os morangos.',
    'Mergulhe cada morango no iogurte e disponha sobre uma assadeira forrada com papel manteiga.',
    'Leve ao freezer por cerca de 30 minutos, até o iogurte firmar.',
    'Derreta o chocolate em banho-maria ou no micro-ondas, mexendo a cada 30 segundos.',
    'Retire os morangos do freezer e mergulhe-os no chocolate derretido, cobrindo bem.',
    'Volte à assadeira e leve ao freezer por mais 10 minutos para o chocolate endurecer.',
    'Sirva em seguida ou mantenha refrigerado até consumir.'
  ],
  tempo_preparo: 50, // Preparo: 10 minutos + Freezer: 40 minutos = 50 minutos
  porcoes: 1, // 1 porção (10 unidades)
  dificuldade: 'facil',
  tipo_refeicao: 'snacks', // Sobremesa fit
  tags: ['Sobremesa fit', 'Sem açúcar', 'Refrescante', 'Sem cocção'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por porção - 10 unidades)
  calorias: 310, // Média entre 300-320 kcal
  carboidratos: 22, // Média entre 20-24 g
  proteinas: 9, // Média entre 8-10 g
  gorduras: 21, // Média entre 20-22 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por porção (10 unidades)
* Calorias: ~300–320 kcal
...
– tamanho dos morangos`,
  ...
  substituicoes_ingredientes: {
    'Iogurte grego': ['iogurte natural integral', 'skyr', 'iogurte vegetal sem açúcar'],
    'Chocolate 70%': ['chocolate zero açúcar', 'chocolate 85% cacau'],
    'Morangos': ['uvas', 'banana em rodelas', 'framboesas']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍓🍫 Cadastro de Delícia de Morango com Chocolate${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
