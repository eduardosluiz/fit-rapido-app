/**
 * Script para cadastrar a receita "Rolinho de Abobrinha com Queijo"
 * 
 * USO:
 * Execute: node scripts/cadastrar-rolinho-abobrinha-queijo.js
 * 
 * O script:
...
// Receita "Rolinho de Abobrinha com Queijo"
const receita = {
  titulo: '🥒🧀 Rolinho de Abobrinha com Queijo',
  descricao: 'Leve, prática e versátil, essa receita é perfeita para lanches rápidos, entradas ou refeições leves, com infinitas possibilidades de recheio.',
  ingredientes: [
    '1 abobrinha italiana média',
    '120 g de queijo muçarela ralado ou fatiado',
    'Recheio de sua preferência (ver sugestões abaixo)'
  ],
  modo_preparo: [
    'Prepare a abobrinha: Corte a abobrinha em fatias finas no sentido do comprimento (use mandolina ou faca afiada).',
    'Aqueça a frigideira: Leve uma frigideira antiaderente ao fogo médio e distribua o queijo formando uma base.',
    'Adicione a abobrinha: Coloque as fatias de abobrinha sobre o queijo e deixe dourar até o queijo ficar bem dourado e firme.',
    'Recheie: Acrescente o recheio escolhido sobre a abobrinha.',
    'Finalize: Dobre ou enrole cuidadosamente, formando os rolinhos.',
    'Sirva: Retire da frigideira e sirva ainda quente.'
  ],
  tempo_preparo: 20, // Preparo: 10 minutos + Cozimento: 10 minutos = 20 minutos
  porcoes: 3, // Média entre 2 a 3 porções (arredondado para 3)
  dificuldade: 'facil',
  tipo_refeicao: 'snacks',
  tags: ['Lanche', 'Low carb', 'Vegetariana', 'Sem glúten', 'Rápida'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por porção, com muçarela e recheio leve)
  calorias: 200, // Média entre 180-220 kcal
  carboidratos: 5, // Média entre 4-6 g
  proteinas: 12, // Média entre 10-14 g
  gorduras: 14, // Média entre 12-16 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por porção (com muçarela e recheio leve)
...
– tipo de recheio escolhido
– quantidade de recheio utilizado
– tipo de queijo utilizado`,
  ...
  substituicoes_ingredientes: {
    'Muçarela': ['queijo prato', 'parmesão', 'minas padrão', 'queijo sem lactose'],
    'Abobrinha': ['berinjela fatiada finamente']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🥒🧀 Cadastro de Rolinho de Abobrinha com Queijo${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
