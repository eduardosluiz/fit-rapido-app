/**
 * Script para cadastrar a receita "Picolé de Frutas Vermelhas com Chocolate 70%"
 * 
 * USO:
 * Execute: node scripts/cadastrar-picole-frutas-vermelhas.js
 * 
 * O script:
...
// Receita "Picolé de Frutas Vermelhas com Chocolate 70%"
const receita = {
  titulo: '🍓🍫 Picolé de Frutas Vermelhas com Chocolate 70%',
  descricao: 'Refrescante, frutado e com final intenso de chocolate, perfeito para dias quentes ou como sobremesa leve.',
  ingredientes: [
    'Morangos a gosto',
    'Framboesas a gosto',
    'Mirtilos a gosto',
    ...
    'Chocolate 70% cacau sem açúcar (para finalização)'
  ],
  modo_preparo: [
    'Prepare o purê: Bata os morangos, framboesas e mirtilos no liquidificador até formar um purê homogêneo.',
    'Ajuste o sabor: Adicione o suco de limão e o xarope de tâmaras a gosto. Bata rapidamente para misturar.',
    'Monte os picolés: Distribua a mistura nas formas de picolé, garantindo uma boa distribuição das frutas.',
    'Congele: Leve ao freezer por pelo menos 4 horas ou até ficar completamente firme.',
    'Finalize: Desenforme os picolés e mergulhe parcialmente no chocolate 70% derretido. Leve novamente ao freezer por alguns minutos para firmar o chocolate.'
  ],
  tempo_preparo: 250, // Preparo: 10 minutos + Freezer: 4 horas (240 min) = 250 minutos
  porcoes: 7, // Média entre 6 a 8 picolés
  dificuldade: 'facil',
  tipo_refeicao: 'snacks',
  tags: ['Sobremesa', 'Refrescante', 'Sem açúcar refinado', 'Sem glúten', 'Natural'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por unidade, sem cobertura total de chocolate)
  calorias: 85, // Média entre 70-100 kcal
  carboidratos: 10, // Média entre 8-12 g
  proteinas: 1,
  gorduras: 4, // Média entre 3-5 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por unidade (sem cobertura total de chocolate)
* Calorias: ~70–100 kcal
* Proteínas: ~1 g
* Gorduras: ~3–5 g
* Carboidratos: ~8–12 g

➡️ Valores podem variar conforme:
– quantidade de chocolate utilizado
– quantidade de adoçante utilizado
– proporção de frutas utilizadas`,
  ...
  substituicoes_ingredientes: {
    'Xarope de tâmaras': ['mel', 'melado', 'adoçante natural'],
    'Frutas vermelhas': ['frutas congeladas que preferir'],
    'Chocolate 70%': ['chocolate 80% sem açúcar']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍓🍫 Cadastro de Picolé de Frutas Vermelhas com Chocolate 70%${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
