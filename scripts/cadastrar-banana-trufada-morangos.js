/**
 * Script para cadastrar a receita "Banana Trufada com Morangos"
 * 
 * USO:
 * Execute: node scripts/cadastrar-banana-trufada-morangos.js
 * 
 * O script:
...
// Receita "Banana Trufada com Morangos"
const receita = {
  titulo: '🍌🍫 Banana Trufada com Morangos',
  descricao: 'Cremosa, intensa e naturalmente doce, essa sobremesa é perfeita para quem quer algo simples, rápido e delicioso.',
  ingredientes: [
    '2 bananas maduras',
    '80 g de chocolate 70% cacau sem açúcar',
    'Morangos a gosto'
  ],
  modo_preparo: [
    'Derreta o chocolate: Derreta o chocolate em banho-maria ou no micro-ondas, mexendo a cada 30 segundos até ficar liso.',
    'Prepare o creme: Bata as bananas com o chocolate derretido até obter um creme homogêneo e brilhante.',
    'Monte a travessa: Lave e disponha os morangos em uma travessa ou refratário.',
    'Finalize: Despeje o creme de banana e chocolate sobre os morangos, cobrindo bem.',
    'Geladeira: Leve à geladeira por pelo menos 1 hora para firmar.',
    'Sirva: Corte em pedaços e sirva gelado.'
  ],
  tempo_preparo: 70, // Preparo: 10 minutos + Geladeira: 1 hora (60 min) = 70 minutos
  porcoes: 5, // Média entre 4 a 6 porções
  dificuldade: 'facil',
  tipo_refeicao: 'snacks',
  tags: ['Sobremesa', 'Sem açúcar refinado', 'Sem glúten', 'Prática', 'Poucos ingredientes'],
...
– maturação da banana
– quantidade de morangos utilizada`,
  ...
  substituicoes_ingredientes: {
    ...
    'Morangos': ['frutas vermelhas variadas', 'banana em rodelas'],
    'Banana': ['manga madura', 'purê de maçã (ajusta sabor e textura)']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍌🍫 Cadastro de Banana Trufada com Morangos${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
