/**
 * Script para cadastrar a receita "Bombom Proteico com Chocolate 80%"
 * 
 * USO:
 * Execute: node scripts/cadastrar-bombom-proteico-chocolate.js
 * 
 * O script:
...
// Receita "Bombom Proteico com Chocolate 80%"
const receita = {
  titulo: '🍫🍓 Bombom Proteico com Chocolate 80%',
  descricao: 'Uma sobremesa funcional, rica em proteínas e com textura cremosa, perfeita para matar a vontade de doce de forma equilibrada.',
  ingredientes: [
    'Chocolate 80% cacau sem açúcar (2 quadradinhos por forminha)',
    'Sementes a gosto (chia, linhaça, abóbora, gergelim, girassol, etc.)',
    '2 scoops de whey protein sabor baunilha',
    '4 colheres de sopa de leite em pó',
    'Aproximadamente 60 ml de água morna',
    'Frutas de sua preferência para finalizar'
  ],
  modo_preparo: [
    'Derreta o chocolate: Coloque 2 quadradinhos de chocolate em cada forminha e derreta em banho-maria ou no micro-ondas. Espalhe o chocolate pelas laterais e fundo das forminhas. Reserve.',
    'Toste as sementes: Leve as sementes ao fogo baixo apenas para dar uma leve tostada. Distribua uma porção sobre o chocolate nas forminhas e leve ao freezer por alguns minutos para firmar.',
    'Prepare o creme proteico: Misture o whey protein, o leite em pó e a água morna aos poucos, mexendo até formar um creme liso e consistente. Ajuste a quantidade de água se necessário.',
    'Monte: Retire as forminhas do freezer e adicione uma porção do creme proteico em cada uma.',
    'Finalize: Na hora de servir, finalize com as frutas de sua preferência.'
  ],
  tempo_preparo: 45, // Preparo: 20 minutos + Freezer: 20-30 minutos (média 25) = 45 minutos
  porcoes: 7, // Média entre 6 a 8 unidades
  dificuldade: 'facil',
  tipo_refeicao: 'snacks',
  tags: ['Sobremesa', 'Proteica', 'Sem açúcar', 'Sem glúten', 'Prática'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por unidade)
  calorias: 125, // Média entre 110-140 kcal
  carboidratos: 5, // Média entre 4-6 g
  proteinas: 10, // Média entre 8-11 g (arredondado)
  gorduras: 7, // Média entre 6-8 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por unidade
...
– tipo de sementes escolhidas
– frutas utilizadas na finalização
– quantidade de whey protein`,
  ...
  substituicoes_ingredientes: {
    'Chocolate 80%': ['chocolate 70% sem açúcar'],
    'Whey protein': ['proteína vegetal sabor baunilha'],
    'Leite em pó': ['leite em pó desnatado', 'leite em pó sem lactose'],
    'Sementes': ['granola sem açúcar', 'castanhas picadas']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍫🍓 Cadastro de Bombom Proteico com Chocolate 80%${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
