/**
 * Script para cadastrar a receita "Bombons de Chocolate 70% com Granola e Morangos"
 * 
 * USO:
 * Execute: node scripts/cadastrar-bombons-chocolate-granola.js
 * 
 * O script:
...
// Receita "Bombons de Chocolate 70% com Granola e Morangos"
const receita = {
  titulo: '🍫🍓 Bombons de Chocolate 70% com Granola e Morangos',
  descricao: 'Bombons crocantes por fora, com camadas equilibradas de chocolate, granola e frutas frescas.',
  ingredientes: [
    '200 g de chocolate 70% cacau sem açúcar',
    'Granola low carb sem açúcar (a gosto)',
    'Morangos frescos picados',
    'Creme de proteína (opcional):',
    '1 scoop de proteína em pó',
    '1 colher de sopa de pasta de amendoim',
    '20 ml de água'
  ],
  modo_preparo: [
    'Derreta o chocolate em banho-maria ou no micro-ondas, mexendo para não queimar.',
    'Faça uma primeira camada de chocolate no fundo dos moldes.',
    'Leve à geladeira por alguns minutos até firmar levemente.',
    'Acrescente uma camada de granola.',
    'Distribua os morangos picados e, se desejar, o creme de proteína.',
    'Cubra com mais chocolate derretido.',
    'Finalize com uma camada de granola por cima.',
    'Leve à geladeira até firmar completamente.'
  ],
  tempo_preparo: 45, // Preparo: 10 minutos + Geladeira: 30–40 minutos (média 35) = ~45 minutos
  porcoes: 9, // 8 a 10 bombons (usando 9 como média)
  dificuldade: 'facil',
  tipo_refeicao: 'snacks', // Sobremesa fit
  tags: ['Sobremesa fit', 'Sem açúcar', 'Low carb', 'Sem cocção'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por unidade)
  calorias: 135, // Média entre 120-150 kcal
  carboidratos: 7, // Média entre 6-9 g (arredondado)
  proteinas: 4, // Média entre 3-5 g
...
– uso do creme proteico`,
  ...
  substituicoes_ingredientes: {
    'Chocolate 70% sem açúcar': ['chocolate zero açúcar', 'chocolate 85% cacau'],
    'Granola low carb': ['castanhas trituradas', 'coco ralado sem açúcar', 'sementes (chia, linhaça)'],
    'Morangos': ['framboesa', 'mirtilo', 'banana em rodelas finas'],
    'Proteína em pó (creme)': ['leite em pó', 'whey vegetal', 'não utilizar'],
    'Pasta de amendoim': ['pasta de castanha de caju', 'pasta de amêndoas']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍫🍓 Cadastro de Bombons de Chocolate 70% com Granola e Morangos${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
