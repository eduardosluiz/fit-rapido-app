/**
 * Script para cadastrar a receita "Bolo Fit de Aveia com Blueberry"
 * 
 * USO:
 * Execute: node scripts/cadastrar-bolo-aveia-blueberry.js
 * 
 * O script:
...
// Receita "Bolo Fit de Aveia com Blueberry"
const receita = {
  titulo: '🫐 Bolo Fit de Aveia com Blueberry',
  descricao: 'Bolo macio, nutritivo e levemente adocicado, perfeito para o café da manhã ou lanche da tarde.',
  ingredientes: [
    '2 xícaras de farelo de aveia',
    '1 pitada de sal',
    '½ xícara de adoçante da sua preferência',
    ...
    'Chocolate branco sem açúcar ralado ou derretido'
  ],
  modo_preparo: [
    'Em um bowl, coloque os ovos e o adoçante e misture bem.',
    'Acrescente a essência de baunilha, o óleo de coco e a pitada de sal.',
    'Adicione o leite vegetal e o farelo de aveia, misturando até formar uma massa homogênea.',
    'Incorpore delicadamente os blueberries e o fermento.',
    ...
    'Após assar, finalize com chocolate branco sem açúcar, se desejar.'
  ],
  tempo_preparo: 50, // Preparo: 10 minutos + Cozimento: ~40 minutos = ~50 minutos
  porcoes: 12, // 12 fatias
  dificuldade: 'facil',
  tipo_refeicao: 'snacks', // Lanche saudável / Sobremesa fit
  tags: ['Lanche saudável', 'Sobremesa fit', 'Fonte de fibras', 'Sem açúcar'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por fatia - 1/12 da receita)
  calorias: 80, // Média entre 75-85 kcal
  carboidratos: 11, // Média entre 10-12 g
  proteinas: 3,
  gorduras: 4,
  fibras: 2,
  sodio: null,
  informacoes_nutricionais: `Por fatia (1/12 da receita)
* Calorias: ~75–85 kcal
...
– adoçante utilizado
– tipo de leite vegetal
– quantidade de chocolate na finalização`,
  ...
  substituicoes_ingredientes: {
    'Farelo de aveia': ['farinha de aveia', 'mix de aveia + farinha de amêndoas'],
    'Adoçante': ['xilitol', 'eritritol', 'blend culinário'],
    'Leite vegetal': ['leite sem lactose', 'bebida de amêndoas', 'bebida de coco', 'bebida de aveia'],
    'Óleo de coco': ['manteiga ghee', 'azeite suave'],
    'Blueberry': ['morango', 'framboesa', 'maçã em cubos', 'banana em rodelas'],
    'Chocolate branco zero': ['chocolate 70% cacau sem açúcar', 'não usar']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🫐 Cadastro de Bolo Fit de Aveia com Blueberry${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
  ...
  console.log(`   Fibras: ${receita.fibras} g`);
