/**
 * Script para cadastrar a receita "Bolo de Cenoura Fit com Chocolate"
 * 
 * USO:
 * Execute: node scripts/cadastrar-bolo-cenoura-fit.js
 * 
 * O script:
...
// Receita "Bolo de Cenoura Fit com Chocolate"
const receita = {
  titulo: '🥕🍫 Bolo de Cenoura Fit com Chocolate',
  descricao: 'Bolo fofinho, intenso e nutritivo, feito com farinhas low carb e adoçado sem açúcar.',
  ingredientes: [
    '4 ovos',
    '270 g de xilitol',
    '275 g de cenoura crua',
    '190 g de óleo (milho, coco ou outro de sua preferência)',
    '110 g de farinha de coco',
    '10 g de farinha de amêndoas',
    '10 g de fermento químico',
    'Opcional:',
    'Pedaços de chocolate sem açúcar'
  ],
  modo_preparo: [
    'Pré-aqueça o forno a 180 °C.',
    'No liquidificador, bata os ovos, a cenoura e o xilitol até obter uma mistura homogênea.',
    'Adicione o óleo e bata novamente.',
    'Em uma tigela, peneire a farinha de coco e misture com a farinha de amêndoas e o fermento.',
    'Incorpore a mistura seca à massa batida, mexendo delicadamente.',
    'Se desejar, acrescente pedaços de chocolate sem açúcar.',
    'Despeje a massa em uma forma untada.',
    'Leve ao forno por cerca de 45 minutos, sem abrir antes do tempo.',
    'Faça o teste do palito antes de retirar.'
  ],
  tempo_preparo: 60, // Preparo: 15 minutos + Cozimento: ~45 minutos = 60 minutos
  porcoes: 12, // 1 bolo médio (10–12 fatias) - usando 12 como padrão
  dificuldade: 'medio',
  tipo_refeicao: 'snacks', // Sobremesa fit
  tags: ['Sobremesa fit', 'Sem açúcar', 'Sem glúten', 'Low carb'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por fatia - 1/12 do bolo)
  calorias: 190, // Média entre 180-200 kcal
  carboidratos: 11, // Média entre 10-13 g (arredondado)
  proteinas: 4.5, // Média entre 4-5 g
  gorduras: 15, // Média entre 14-16 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por fatia (1/12 do bolo)
...
– tamanho das fatias`,
  ...
  substituicoes_ingredientes: {
    'Xilitol': ['eritritol', 'blend culinário (mesma proporção)'],
    'Óleo de milho': ['óleo de coco', 'azeite suave', 'óleo de abacate'],
    'Farinha de coco': ['parte por farinha de amêndoas (ajuste: farinha de coco absorve mais líquido)'],
    'Farinha de amêndoas': ['farinha de castanha de caju'],
    'Chocolate sem açúcar': ['chocolate 70% cacau', 'não usar']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🥕🍫 Cadastro de Bolo de Cenoura Fit com Chocolate${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
