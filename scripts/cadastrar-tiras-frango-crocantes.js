/**
 * Script para cadastrar a receita "Tiras de Frango Crocantes"
 * 
 * USO:
 * Execute: node scripts/cadastrar-tiras-frango-crocantes.js
 * 
 * O script:
...
const receita = {
  titulo: '🍗✨ Tiras de Frango Crocantes',
  descricao: 'Crocantes por fora, macias por dentro e super versáteis. Uma ótima opção de lanche proteico ou refeição leve, com possibilidade de congelamento.',
  ingredientes: [
    '300 g de frango cru (peito ou sobrecoxa sem pele)',
    'Alho, cebola e salsa a gosto (frescos ou congelados)',
    'Pimenta-caiena a gosto',
    'Sal a gosto',
    '2 a 3 colheres de sopa de parmesão ralado',
    'Farinha panko ou farinha de amêndoas para empanar (opcional)',
  ...
  modo_preparo: [
    'No mixer ou processador, bata o frango com alho, cebola, salsa, sal, pimenta-caiena e parmesão até formar uma massa homogênea.',
    'Transfira a mistura para um saco plástico ou recipiente, modele em um bloco uniforme e leve ao freezer até firmar (cerca de 1 hora).',
    'Retire do freezer e corte em palitinhos.',
    'Se desejar, empane no panko ou na farinha de amêndoas.',
    'Leve à airfryer ou ao forno preaquecido a 200 °C até dourar e ficar crocante, virando na metade do tempo.',
    'Molho de Iogurte (Opcional):',
    'Misture todos os ingredientes em um recipiente até ficar homogêneo.',
    'Sirva gelado acompanhando as tiras de frango.'
  ],
  tempo_preparo: 92, // Preparo: 15 minutos + Freezer: 1 hora (60 min) + Cocção: 15-20 minutos (média 17.5) = ~92 minutos
  porcoes: 3, // Média entre 2 a 3 porções (arredondado para 3)
  dificuldade: 'medio',
  tipo_refeicao: 'snacks',
  tags: ['Lanche', 'Proteica', 'Crocante', 'Sem glúten (com farinha de amêndoas)', 'Airfryer'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por porção, sem empanar)
  calorias: 240, // Média entre 220-260 kcal
  carboidratos: 3, // Média entre 2-4 g
  proteinas: 30, // Média entre 28-32 g
  gorduras: 9, // Média entre 8-10 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por porção (sem empanar)
...
– tipo de empanamento utilizado
– método de preparo (airfryer ou forno)
– quantidade de parmesão
– uso do molho de iogurte`,
  ...
  substituicoes_ingredientes: {
    'Parmesão': ['muçarela', 'queijo meia-cura'],
    'Panko': ['farinha de amêndoas', 'farinha de aveia', 'sem empanar'],
    'Pimenta-caiena': ['páprica doce', 'páprica defumada', 'pimenta-do-reino']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🍗✨ Cadastro de Tiras de Frango Crocantes${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
