/**
 * Script para cadastrar a receita "Rosca de Polvilho Assada"
 * 
 * USO:
 * Execute: node scripts/cadastrar-rosca-polvilho.js
 * 
 * O script:
...
// Receita "Rosca de Polvilho Assada"
const receita = {
  titulo: '🥨🧀 Rosca de Polvilho Assada',
  descricao: 'Crocante por fora, macia por dentro e perfeita para acompanhar café ou lanche.',
  ingredientes: [
  ...
  modo_preparo: [
    'Em uma tigela, misture o polvilho, o óleo e o leite.',
    'Adicione o sal e a água quente, mexendo bem até formar uma massa homogênea.',
    'Incorpore o ovo por último, misturando até ficar uniforme.',
    'Transfira a massa para uma forma untada, modele em formato de rosca e finalize com parmesão ralado por cima.',
    'Leve ao forno preaquecido a 200°C por cerca de 35 minutos, até dourar.'
  ],
  tempo_preparo: 45, // Preparo: 10 minutos + Forno: 35 minutos = 45 minutos
  porcoes: 7, // Média entre 6 a 8 porções
  dificuldade: 'facil',
  tipo_refeicao: 'snacks',
  tags: ['Pão funcional', 'Snack salgado', 'Sem glúten', 'Fácil'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por porção - 1/8 da rosca)
  calorias: 180, // Média entre 170-190 kcal
  carboidratos: 20, // Média entre 18-22 g
  proteinas: 4, // Média entre 3-4 g (arredondado)
  gorduras: 10, // Média entre 9-11 g
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por porção (1/8 da rosca)
...
– tipo de queijo utilizado`,
  ...
  substituicoes_ingredientes: {
    'Polvilho azedo': ['polvilho doce (textura um pouco menos crocante)'],
    'Óleo': ['óleo de coco', 'azeite de oliva suave'],
    'Leite': ['leite vegetal (amêndoas, coco ou aveia)'],
    'Parmesão': ['queijo meia-cura', 'muçarela ralada', 'versão sem lactose']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🥨🧀 Cadastro de Rosca de Polvilho Assada${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
