/**
 * Script para cadastrar a receita "Shake Proteico de Café com Chocolate"
 * 
 * USO:
 * Execute: node scripts/cadastrar-shake-proteico-cafe.js
 * 
 * O script:
...
// Receita "Shake Proteico de Café com Chocolate"
const receita = {
  titulo: '☕🍫 Shake Proteico de Café com Chocolate',
  descricao: 'Cremoso, energético e cheio de sabor, ideal para dar aquele gás no treino ou substituir um lanche rápido.',
  ingredientes: [
    '4 a 5 cubos de café congelado',
    '200 ml de leite vegetal ou leite de sua preferência',
    '1 scoop de whey protein sabor chocolate',
    '1 colher de sobremesa de pasta de amendoim',
    '1 colher de chá de xarope de tâmara ou adoçante a gosto (opcional)',
  ...
  modo_preparo: [
    ...
    'Despeje em um copo.',
    'Finalize com uma pitada de canela por cima, se desejar.'
  ],
  tempo_preparo: 3, // Preparo: 3 minutos
  porcoes: 1, // 1 copo
  dificuldade: 'facil',
  tipo_refeicao: 'drinks',
  tags: ['Bebida', 'Proteica', 'Energética', 'Sem glúten', 'Pré ou pós-treino'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por copo)
  calorias: 240, // Média entre 220-260 kcal
  carboidratos: 12, // Média entre 10-14 g
  proteinas: 24, // Média entre 22-26 g
  gorduras: 10, // Média entre 8-11 g (arredondado)
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por copo
...
– tipo de whey utilizado
– quantidade de pasta de amendoim
– uso de adoçante`,
  ...
  substituicoes_ingredientes: {
    'Whey de chocolate': ['whey de baunilha', 'proteína vegetal'],
    'Leite vegetal': ['leite sem lactose', 'água'],
    'Pasta de amendoim': ['pasta de amêndoas', 'pasta de castanha de caju']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  ☕🍫 Cadastro de Shake Proteico de Café com Chocolate${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
  ...
  console.log(`   Calorias: ${receita.calorias} kcal (por copo)`);
  console.log(`   Carboidratos: ${receita.carboidratos} g (por copo)`);
  console.log(`   Proteínas: ${receita.proteinas} g (por copo)`);
  console.log(`   Gorduras: ${receita.gorduras} g (por copo)`);
