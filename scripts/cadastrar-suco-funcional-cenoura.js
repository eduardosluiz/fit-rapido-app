/**
 * Script para cadastrar a receita "Suco Funcional de Cenoura, Beterraba e Manga"
 * 
 * USO:
 * Execute: node scripts/cadastrar-suco-funcional-cenoura.js
 * 
 * O script:
...
// Receita "Suco Funcional de Cenoura, Beterraba e Manga"
const receita = {
  titulo: '🥕🍊 Suco Funcional de Cenoura, Beterraba e Manga',
  descricao: 'Rico em antioxidantes, vitaminas e compostos anti-inflamatórios, ideal para hidratar e nutrir a pele de dentro para fora.',
  ingredientes: [
    '½ cenoura média',
    '¼ beterraba',
    '¼ manga',
  ...
  modo_preparo: [
    'Corte a cenoura, a beterraba e a manga em pedaços pequenos.',
    'Esprema a laranja.',
    'Coloque todos os ingredientes no liquidificador.',
    'Adicione água ou água de coco até atingir a textura desejada.',
    'Bata bem até obter um suco homogêneo.',
    'Se preferir, coe.',
    'Sirva gelado.'
  ],
  tempo_preparo: 5, // Preparo: 5 minutos
  porcoes: 1, // 1 copo
  dificuldade: 'facil',
  tipo_refeicao: 'drinks',
  tags: ['Bebida funcional', 'Antioxidante', 'Refrescante', 'Sem glúten', 'Natural'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por copo)
  calorias: 130, // Média entre 120-140 kcal
  carboidratos: 28, // Média entre 26-30 g
  proteinas: 2, // Média entre 1-2 g (arredondado)
  gorduras: 0,
  fibras: null,
  sodio: null,
...
* Proteínas: ~1–2 g
* Gorduras: ~0 g
* Carboidratos: ~26–30 g

✨ Benefícios:
* Rico em antioxidantes
* Fonte de vitaminas
* Compostos anti-inflamatórios
* Ideal para hidratar e nutrir a pele

➡️ Valores podem variar conforme:
– tamanho das frutas utilizadas
– quantidade de água ou água de coco
– proporção dos ingredientes`,
  ...
  substituicoes_ingredientes: {
    'Manga': ['mamão', 'pêssego'],
    'Laranja': ['tangerina', 'limão (ajuste a quantidade)'],
    'Água de coco': ['água filtrada']
  }
};
...
async function main() {
  ...
  console.log(`${colors.blue}  🥕🍊 Cadastro de Suco Funcional de Cenoura, Beterraba e Manga${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
