/**
 * Script para cadastrar a receita "Geleia de Morango Fit"
 * 
 * USO:
 * Execute: node scripts/cadastrar-geleia-morango.js
 * 
 * O script:
...
// Receita "Geleia de Morango Fit"
const receita = {
  titulo: '🍓 Geleia de Morango Fit',
  descricao: 'Geleia caseira, naturalmente saborosa, com poucos ingredientes e perfeita para o dia a dia.',
  ingredientes: [
    'Morangos (frescos ou congelados) – cerca de 1 xícara',
  ...
  modo_preparo: [
    ...
    'Cozinhe até os morangos desmancharem e o líquido reduzir, formando uma geleia.',
    'Ajuste a textura conforme sua preferência: mais tempo no fogo para uma geleia mais consistente.',
    'Deixe esfriar antes de armazenar.'
  ],
  tempo_preparo: 17, // Preparo: 2 minutos + Cozimento: 10-15 minutos (média 12.5) = ~15 minutos
  porcoes: 1, // 1 pote pequeno (aprox. 200 ml)
  dificuldade: 'facil',
  tipo_refeicao: 'sides', // Acompanhamento
  tags: ['Acompanhamento', 'Sem açúcar', 'Low carb'],
  is_premium: true, // Receita PREMIUM por padrão
  is_free: false,
  // Informações nutricionais (por porção - 1 colher de sopa)
  calorias: 25, // Média entre 20-30 kcal
  carboidratos: 5, // Média entre 4-6 g
  proteinas: 0.3,
  gorduras: 0,
  fibras: null,
  sodio: null,
  informacoes_nutricionais: `Por porção (1 colher de sopa)
* Calorias: ~20–30 kcal
* Carboidratos: ~4–6 g
* Proteínas: ~0,3 g
* Gorduras: ~0 g
...
async function main() {
  ...
  console.log(`${colors.blue}  🍓 Cadastro de Geleia de Morango Fit${colors.reset}`);
  console.log(`${colors.blue}═══════════════════════════════════════${colors.reset}\n`);
